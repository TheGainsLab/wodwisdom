...
**(6) ~~fix round on #560~~ DONE — pushed (`5ffde54`), re-verify requested.** All 2🔴+6🟠+🟡 +
Decision 8 + JOINT-1 addressed (see #560 row). **NEXT: reviewer re-verifies → merge** (also fold in the affiliate's conformance
