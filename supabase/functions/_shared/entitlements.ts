...
// The gym-channel grant allowlist (ALLOWED_GRANT_FEATURES / ENGINE_DRIP_FEATURES)
// was retired in the Decision 12a Phase C sweep with the seat-grant machinery:
// gym members live on their gym's member app and never hold wodwisdom entitlements.
