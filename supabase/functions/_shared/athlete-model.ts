...
export interface AthleteModelContent {
  ...
  /** The Tier-3 qualitative intake (free-text/voice → structured): preferences,
   *  self-assessment, training history, constraints. ALL self-reported opinion —
   *  CoachState honors preferences (selection/adherence), treats self-assessment
