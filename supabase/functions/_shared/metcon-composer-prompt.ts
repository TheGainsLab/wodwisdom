...
SET-LEVEL RULES (deterministically audited — violations come back to you once)
  ...
  5. BARBELL PRESENCE: when the athlete has a barbell and legal barbell movements, the month NORMALLY includes 2–3 barbell-bearing pieces at cycling loads — unless the coach's guidance argues otherwise (a letter that deliberately de-emphasizes loading, e.g. engine-first with no Olympic lifting, may run lighter). Zero barbell for a capable athlete WITHOUT such guidance is a defect.
