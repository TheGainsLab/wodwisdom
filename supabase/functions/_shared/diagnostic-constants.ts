...
export const MOVEMENTS: Record<string, MovementMetadata> = {
  ...
  clean_deadlift_slow_pull:   { name: "clean_deadlift_slow_pull",   category: "strength",  equipment: ["barbell"],            min_tier: "beginner" },
  ...
  pause_front_squat:          { name: "pause_front_squat",          category: "strength",  equipment: ["barbell"],            min_tier: "beginner" },
  ...
  push_press_strict:          { name: "push_press_strict",          category: "strength",  equipment: ["barbell"],            min_tier: "beginner" },
  snatch_balance:             { name: "snatch_balance",             category: "position",  equipment: ["barbell"],            min_tier: "intermediate" },
  snatch_deadlift_slow_pull:  { name: "snatch_deadlift_slow_pull",  category: "strength",  equipment: ["barbell"],            min_tier: "beginner" },
  ...
  tempo_front_squat:          { name: "tempo_front_squat",          category: "strength",  equipment: ["barbell"],            min_tier: "beginner" },
