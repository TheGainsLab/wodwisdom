...
- Format each block as MULTI-LINE text — NEVER use commas to join movements on one line:
  ...
  • Warm-up and Cool-down blocks: list each drill on its own line (e.g. "400m row\n10 pass-throughs\n10 air squats"). NEVER comma-separate them.
