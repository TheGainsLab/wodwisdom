...
- block_scheme prose never states absolute loads ("@195 lbs") — the movement rows carry the computed weights; percentages ("@75%") are fine. Distance prose uses ft or m, never yards.
