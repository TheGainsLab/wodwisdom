          ...
          return (
            ...
            >
              ...
              {isCompleted ? (
                ...
                // Quiet affordance on today only: actions live behind the tiles,
                // and today is the tile that almost always has one.
                <svg className="wc-cell-plus" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" aria-hidden="true">
