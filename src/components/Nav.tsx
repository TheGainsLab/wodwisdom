              ...
              <>
                ...
                {engineExpanded && (
                  <div className="nav-group-items">
                    ...
                    {/* Coach capabilities (not Engine features) — but Engine-only
                        athletes have no Training group, so they surface here.
                        My Calendar is where logged activities render. */}
                    {!hasProgramming && (
                      <>
