    ...
    <>
      ...
      <nav className={"nav-sidebar " + (isOpen ? "open" : "")}>
        ...
        <div className="nav-links">
          ...
          {/* Athlete Data: open to any authenticated user. View tier (search,
              catalog browse, view your own linked athlete's bundle) is free.
              Try-It logging on past workouts is gated separately inside the
              page on `competition_log` or `programming`. */}
