...
export const SUPABASE_URL = import.meta.env.VITE_SUPABASE_URL || 'https://hsiqzmbfulmfxbvbsdwz.supabase.co';
...
export const ADJUST_WORKOUT_ENDPOINT = SUPABASE_URL + '/functions/v1/adjust-workout';
