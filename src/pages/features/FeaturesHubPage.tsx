...
const FEATURES = [
  {
    title: 'AI Coaching',
    description: 'Get answers you can trust, grounded in the methodology. Or go deeper—switch to science mode and talk with an AI trained on physiology and biochemistry.',
